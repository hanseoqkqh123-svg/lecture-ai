                        ...
                        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                            ...
                            <div className="mt-4 flex flex-wrap gap-3">
                                <button
                                    ...
                                    className="rounded-2xl bg-slate-900 px-5 py-3 text-white shadow-sm hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                                    녹음 시작
                                </button>
                                ...
                                <button
                                    ...
                                    disabled={!isRecording}
                                    className="rounded-2xl border border-slate-300 px-5 py-3 text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
                                >
                                    녹음 종료
                                </button>
                            ...
                            {!generated ? (
                                ...
                                <div className="mt-4 space-y-3">
                                    {notes.map((note) => (
                                        <div
                                            key={note.id}
                                            className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-slate-800"
                                        >
                                            <div className="text-sm font-semibold text-slate-500">
                                                핵심 요약 {note.id}
                                            </div>
                            ...
                            <div className="mt-4 flex flex-wrap gap-3">
                                {keywords.length === 0 ? (
                                    ...
                                    keywords.map((item) => (
                                        <div
                                            key={item.word}
                                            className="rounded-full border border-slate-200 bg-slate-100 px-4 py-2 text-sm font-medium text-slate-800"
                                        >
                                            {item.word}{" "}
